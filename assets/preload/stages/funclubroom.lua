function onCreate()
	...
	makeLuaSprite('bg2', 'MainBG2', 0, 0)
	setLuaSpriteScrollFactor('bg2', 0.6, 0.6)
	scaleObject('bg2', 1.6, 1.6)
	addLuaSprite('bg2', false)


	makeAnimatedLuaSprite('lights_back2','lights_back2',0,0)
